...
/**
 * This is the model class for table "et_ophcianassessment_checklist".
 *
...
class Element_OphCiAnaestheticassessment_Checklist  extends  BaseEventTypeElement
{
	/**
	...
	{
		return 'et_ophcianassessment_checklist';
	}
	...
	{
		return array(
			array('event_id, previous_surgical_procedures, patient_anesthesia, family_anesthesia, pain, cardiovascular, respiratory, gastro_intestinal, diabetes, genitourinary_renal_endocrine, neuro_musculoskeletal, falls_mobility_risk, miscelaneous, psychiatric, pregnancy_status, exposure, dental, tabacco_use, alcohol_use, recreational_drug_use, ', 'safe'),
			array('previous_surgical_procedures, patient_anesthesia, family_anesthesia, pain, cardiovascular, respiratory, gastro_intestinal, diabetes, genitourinary_renal_endocrine, neuro_musculoskeletal, falls_mobility_risk, miscelaneous, psychiatric, pregnancy_status, exposure, dental, tabacco_use, alcohol_use, recreational_drug_use, ', 'required'),
			array('id, event_id, previous_surgical_procedures, patient_anesthesia, family_anesthesia, pain, cardiovascular, respiratory, gastro_intestinal, diabetes, genitourinary_renal_endocrine, neuro_musculoskeletal, falls_mobility_risk, miscelaneous, psychiatric, pregnancy_status, exposure, dental, tabacco_use, alcohol_use, recreational_drug_use, ', 'safe', 'on' => 'search'),
		);
	}
