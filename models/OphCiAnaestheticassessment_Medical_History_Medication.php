...
/**
 * This is the model class for table "ophcianassessment_medical_history_medication".
 *
...
class OphCiAnaestheticassessment_Medical_History_Medication extends BaseActiveRecordVersioned
{
	/**
	...
	{
		return 'ophcianassessment_medical_history_medication';
	}
