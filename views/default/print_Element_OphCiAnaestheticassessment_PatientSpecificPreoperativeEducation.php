...
<table class="subtleWhite normalText">
	<tbody>
		<tr>
			<td colspan="2">
				<div class="colThird">
					<b><?php echo CHtml::encode($element->getAttributeLabel('speced_id'))?>:</b>
					<div class="eventHighlight medium">
						<?php if (!$element->speced_ids) {?>
							<h4>None</h4>
						<?php } else {?>
							<h4>
		...
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('medications'))?></td>
			<td><span class="big"><?php echo CHtml::encode($element->medications)?></span></td>
		</tr>
		<tr>
