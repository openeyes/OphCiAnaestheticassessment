...
<section class="element <?php echo $element->elementType->class_name?>"
	...
	<?php echo $form->textField($element, 'waiting_comments', array('size' => '10'))?>
	<?php echo $form->dropDownList($element, 'asa_level_id', CHtml::listData(OphCiAnaestheticassessment_AnesthesiaPlan_AsaLevel::model()->findAll(array('order'=> 'display_order asc')),'id','name'),array('empty'=>'- Please select -'))?>
	<?php echo $form->dropDownList($element, 'anesthesia_plan_id', CHtml::listData(OphCiAnaestheticassessment_AnesthesiaPlan_AnesthesiaPlan::model()->findAll(array('order'=> 'display_order asc')),'id','name'),array('empty'=>'- Please select -'))?>
	<?php echo $form->textField($element, 'anesthesia_plan_comment', array('size' => '10'))?>
	</div>
