...
<div class="element-fields">
	<?php echo $form->dropDownList($element, 'surgery_approval_id', CHtml::listData(OphCiAnaestheticassessment_AnesthesiaPlan_SurgeryApproval::model()->findAll(array('order'=> 'display_order asc')),'id','name'),array('empty'=>'- Please select -','class'=>'linked-fields','data-linked-fields'=>'not_apps,acceptance_id','data-linked-values'=>'Not approved for surgery,Awaiting further information do not schedule'),false,array('label' => 3, 'field' => 4))?>
	<?php echo $form->multiSelectList($element, 'not_apps', 'not_apps', 'na_id', CHtml::listData(OphCiAnaestheticassessment_AnesthesiaPlan_NotApp::model()->findAll(array('order'=>'display_order asc')),'id','name'), array(), array('empty' => '- Please select -', 'label' => 'Reason for not approving patient for surgery','class'=>'linked-fields','data-linked-fields'=>'com_na','data-linked-values'=>'Other (please specify)'),!$element->surgery_approval || $element->surgery_approval->name != 'Not approved for surgery',false,null,false,false,array('label' => 3,'field' => 4))?>
